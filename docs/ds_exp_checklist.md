...
|---|:---:|:---:|---------|------|------|
| 33-36 | 🔄 | 0-3 | none | 1M+1M | actor_type=distill-ddpg |
| 37-40 | 🔄 | 0-3 | posthoc | 1M+1M | actor_type=distill-ddpg |
...
> H=5 的 posthoc 需要 `--allow_posthoc_direction_speed_rlpd=True`，作为近似消融而非正式概率方法。
...
## 6. Bijector 内部消融 — 单 seed

| # | 状态 | ds_mode | 说明 |
|---|:---:|---------|------|
| 284 | ⬜ | stereographic | 禁用 log-det Jacobian → 验证修正是否必要 |
| 285 | ⬜ | spherical | 禁用 epsilon-bounded sigmoid → 测极点退化 |
...
| 类别 | 完成 | 运行中 | 待做 |
|------|:---:|:---:|:---:|
| RLPD H=1 (task2) | 16 | 0 | 0 |
| RLPD H=5 (task2) | 16 | 0 | 0 |
| FQL H=5 (task2) | 0 | 8 | 0 |
| FQL H=1 (task2) | 8 | 0 | 0 |
| FQL H=5 QC | 0 | 0 | 8 |
| OGBench 多任务 (含 H1+H5) | 0 | 0 | 120 |
| RoboMimic (含 H1+H5) | 0 | 0 | 96 |
| 消融 | 0 | 0 | 11 |
| Bijector | 0 | 0 | 2 |
| **总计** | **40** | **8** | **245** |
